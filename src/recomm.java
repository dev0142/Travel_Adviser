...
class recomm extends JFrame implements ActionListener {
    ...
    recomm(int a1, int a2,int a3) {
        ...
        try {
            ...
            String query = "select * from recomendations where sno='"+a1+"'union select * from recomendations where sno='"+a2+"'union select * from recomendations where sno='"+a3+"'";
            ;
